...
MarkedIconWithUndo.defaultProps = {
  subTypeCount: null,
};
...
export default connect(mapStateToProps, mapDispatchToProps)(React.memo(MarkedIconWithUndo));
